...
export const products: Product[] = [
  ...
  },
  {
    slug: "sambal",
    title: "Sambal",
    shortDesc: "Turkish-produced sambal sauce made with Capsicum annuum peppers, crafted for the European market",
    longDesc:
      "Virelia's sambal sauce is produced in Turkey using locally grown Capsicum annuum peppers — a variety perfectly suited to Turkey's climate and ideal for sambal's characteristic flavour profile. Rich in heat and depth, our sambal is crafted to meet the taste expectations of the European market, particularly Dutch and Benelux consumers for whom sambal is a staple condiment. Turkey's geographic proximity to the Netherlands and the broader Benelux region makes it a highly efficient sourcing alternative to traditional Southeast Asian origins. Importers benefit from significantly shorter lead times, competitive pricing, and full EU food safety compliance — without compromising on flavour or quality.",
    category: "Pepper & Chili Products",
...
export const categoryInfo: CategoryInfo[] = [
  ...
  },
  {
    ...
    description: "Traditional pepper pastes and chili sauces from Turkey and the Mediterranean. From mild ajvar to fiery harissa and Turkish-produced sambal, authentic heat with complex flavor profiles.",
  },
  {
    name: "Ready-to-Use Sauces",
    slug: "ready-to-use-sauces",
    description: "Authentic Mediterranean and international sauces prepared using time-honored recipes. From classic marinara to signature doner sauces, professional quality made simple.",
  },
  {
